...
print(message.count('Hello'))#counts no.of times the given character appears in string gives 1 because it takes whole word as a count
print(message.find('l'))#it gives the index where the character appears first
print(message.find('World'))#it gives the index where the character appears first irrespective of character or word
print(message.find('universe'))#it gives -ve since the given word is not in string
new_message=message.replace('World','universe')
print(message)#doesnt replace world with universe we have to create a new variable to do so
print(new_message)#here it replaces the world with universe  it is not neccesary to create entirely new variable we can do message=message.replace('','')
#combining strings
greeting='Hello'
name='Dheeraj'
say=greeting+name
