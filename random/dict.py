...
student={'name':'dheeraj','age':23,'courses':['math','physics']}#'name','age' are keys they can be string or integer
print(student)
print(student['name'])
...
print(student.items())#dict_items([('name', 'dheeraj'), ('age', 23), ('courses', ['math', 'physics'])])
