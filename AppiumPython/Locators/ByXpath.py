...
ele_xpath = driver.find_element(By.XPATH, '//android.widget.Button[@resource-id="com.**:id/EnterValue"]')
ele_xpath.click()

driver.find_element(By.XPATH,'//android.widget.EditText').send_keys("sample")  # - Using Xpath_and className
